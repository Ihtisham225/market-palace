...
<div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 gap-2">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Trashed Areas</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
        ...
        <div class="card mb-5 mb-xl-8 mt-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Trashed Areas</span>
                    {{-- <span class="text-muted mt-1 fw-bold fs-7">Over 500 new products</span> --}}
                </h3>
                <div class="card-toolbar">
                    <a href="{{ route('areas') }}" class="btn btn-sm btn-light-primary">
                    <!--end::Svg Icon-->Areas</a>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <form style="display:inline;" action="{{ route('area.restore', $row->id) }}" method="POST" class="restore_record">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form style="display:inline;" action="{{ route('area.delete.permanent', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
