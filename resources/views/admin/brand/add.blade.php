    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card mb-5 mb-xl-10 p-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin:Form-->
                <form id="saveForm" class="form" method="POST" action="javascript:void(0)">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-9 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a brad for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Brand" name="name" id="name"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                    ...
                    <div class="text-center">
                        <a href="{{ route('brands') }}" class="btn btn-light me-3">Cancel</a>
