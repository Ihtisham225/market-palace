        ...
        <div class="card mb-5 mb-xl-10 p-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                ...
                <form id="updateForm" class="form" action="javascript:void(0)" method="POST">
                    ...
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    <div class="row g-9 mb-8" id="data">
                        <!--begin::Col-->
                        <div class="col-md-4 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Brand Name" name="name" value="{{ $info->name }}" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-4 fv-row">
                            <label class="required fs-6 fw-bold mb-2">Shop Type</label>
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="{{ $info->shop_type->title }}" name="shop_type">
                                <option value="{{ $info->shop_type->id }}" selected>{{ $info->shop_type->title }}</option>
                    ...
                    <div class="text-center">
                        <a class="btn btn-light me-3" href="{{ route('brands') }}">Cancel</a>
...
if ($("#updateForm").length > 0) {
    $("#updateForm").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "{{route('brand.update', $info->id)}}",
                type: "POST",
