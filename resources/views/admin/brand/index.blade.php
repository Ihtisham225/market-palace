...
<div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 gap-2">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Brands</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">
                    <a href="{{ route('brands') }}" class="text-gray-600 text-hover-primary">Brands</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
        ...
        <div class="card mb-5 mb-xl-8 mt-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        <!--begin::Form-->
                        <form action="{{ route('brand.search') }}" method="POST">
                            @csrf
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                    ...
                    <!--end::Svg Icon-->Add Brand</a>

                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="{{ route('brand.trashed') }}" class="btn btn-sm btn-light-danger">View Trashed</a>
                    </div>
                    <!--end::Menu item-->
            ...
            <div class="card-body py-3">
                    ...
                    <table class="table align-middle gs-0 gy-4" id="table">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-150px">Shop Type</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $row->shop_type->title }}</a>
                                </td>
                                <td>
                                    <span class="badge badge-{{ $row->status == 1 ? 'primary' : 'danger'}} fs-7 fw-bold">{{ $row->status == 1 ? 'Active' : 'Inactive' }}</span>
                                </td>
                                <td class="text-end">
                                    <a href="{{ route('brand.edit', $row->id) }}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                                    ...
                                    <form style="display:inline;" action="{{ route('brand.delete', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
                ...
                @else
                <h3 style="text-align: center;">No Brands found</h3>
                @endif
                <!--end::Table container-->
            </div>
            <!--begin::Body-->
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Add New Brand</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Brand Title</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a brand name for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Brand Name" name="name" id="name" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
