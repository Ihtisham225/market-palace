                ...
                <form id="saveForm" class="form" method="POST" action="javascript:void(0)">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-9 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Category Title" name="name" id="name"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                    ...
                    <div class="text-center">
                        <a href="{{ route('categories') }}" class="btn btn-light me-3">Cancel</a>
