                    ...
                    <div class="row g-9 mb-8" id="data">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Categoy Title</span>
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Brand Name" name="name" value="{{ $info->title }}" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-4 fv-row">
...
if ($("#updateForm").length > 0) {
    $("#updateForm").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "{{route('category.update', $info->id)}}",
                type: "POST",
