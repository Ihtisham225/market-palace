...
<div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 gap-2">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Categoreis</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">
                    <a href="{{ route('categories') }}" class="text-gray-600 text-hover-primary">Categories</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card mb-5 mb-xl-8 mt-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('category.trashed') }}" class="btn btn-sm btn-light-danger">View Trashed</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc42ae3b0ad">
                        ...
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('category.status') }}">
                            @csrf
                            <div class="px-7 py-5">
                                <!--begin::Input group-->
                                <div class="mb-10">
            ...
            <div class="card-body py-3">
                    ...
                    <table class="table align-middle gs-0 gy-4" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('category.edit', $row->id) }}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                                    ...
                                    <form style="display:inline;" action="{{ route('category.delete', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
                ...
                @else
                <h3 style="text-align: center;">No Categories found</h3>
                @endif
                <!--end::Table container-->
            </div>
            <!--begin::Body-->
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Category Name" name="name" id="name" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
...
if ($("#saveForm").length > 0) {
    $("#saveForm").validate({
        ...
        messages: {
            ...
            maxlength: "Category name maxlength should be 50 characters long."
            },
            shop_type: {
