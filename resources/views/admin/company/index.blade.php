    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card mb-5 mb-xl-8 mt-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('company.trashed') }}" class="btn btn-sm btn-light-danger">View Trashed</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc42ae3b0ad">
                        ...
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('company.status') }}">
                            @csrf
                            <div class="px-7 py-5">
                                <!--begin::Input group-->
                                <div class="mb-10">
            ...
            <div class="card-body py-3">
                    ...
                    <table class="table align-middle gs-0 gy-4" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $row->phone }}</a>
                                    <span class="text-muted fw-bold text-muted d-block fs-7">Email: {{ $row->email }}</span>
                                </td>
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $row->debt }}</a>
                                </td>
                                <td>
                                    <span class="badge badge-{{ $row->status == 1 ? 'primary' : 'danger'}} fs-7 fw-bold">{{ $row->status == 1 ? 'Active' : 'Inactive' }}</span>
                                </td>
                                <td class="text-end">
                                    <a href="{{ route('company.edit', $row->id) }}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                                    ...
                                    <form style="display:inline;" action="{{ route('company.delete', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
                ...
                @else
                <h3 style="text-align: center;">No Companies Found</h3>
                @endif
                <!--end::Table container-->
            </div>
            <!--begin::Body-->
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Company Name" name="name" id="name"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Shop Email" name="phone" id="phone"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="email" class="form-control form-control-solid" placeholder="Enter Company Email" name="email" id="email"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Company Debt" name="debt" id="debt"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
							<div class="d-flex flex-column mb-8">
								...
								<textarea class="form-control form-control-solid" rows="3" name="address" placeholder="Type company Address" id="address"></textarea>
                            </div>
                        </div>
						<!--end::Col-->
                    </div>
...
$(".delete_record").click(function(e) {
    ...
    Swal.fire({
        title: "Are you sure?",
        text: "You will be able to restore it from trash",
        icon: "warning",
        ...
        if (result.value) {
            Swal.fire(
                "Trashed!",
                "Your file has been moved to trashed.",
                "success"
            )
            form.submit();
        }
