            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Pay to Company</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Amount you want to pay" name="amount" id="amount" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                    ...
                    <div class="text-center">
                        <a href="{{ route('company_payments') }}" class="btn btn-light me-3">Cancel</a>
...
if ($("#saveForm").length > 0) {
    $("#saveForm").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                url: "{{route('company_payment.save')}}",
                type: "POST",
