        ...
        <div class="card mb-5 mb-xl-8 mt-8"  id="table">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Dealers</span>
                ...
                <div class="card-toolbar">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        <!--begin::Form-->
                        <form action="{{ route('dealer.search') }}" method="POST">
                            @csrf
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ route('dealer.trashed') }}" class="btn btn-sm btn-light-danger">View Trashed</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc42ae3b0ad">
                        ...
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('dealer.status') }}">
                            @csrf
                            <div class="px-7 py-5">
                                <!--begin::Input group-->
                                <div class="mb-10">
            ...
            <div class="card-body py-3">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('dealer.edit', $row->id) }}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                                    ...
                                    <form style="display:inline;" action="{{ route('dealer.delete', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
                ...
                @else
                <h3 style="text-align: center;">No Dealers Found</h3>
                @endif
                <!--end::Table container-->
            </div>
            <!--begin::Body-->
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Add New Dealer</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Dealer Name" name="name" id="name"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Dealer Phone" name="phone" id="phone"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
							<div class="d-flex flex-column mb-8">
								...
								<textarea class="form-control form-control-solid" rows="3" name="address" placeholder="Type Dealer Address" id="address"></textarea>
                            </div>
                        </div>
						<!--end::Col-->
                    </div>
...
if ($("#saveForm").length > 0) {
    $("#saveForm").validate({
        ...
        messages: {
            ...
            address: {
            required: "Please type dealer address",
