        ...
        <div class="card mb-5 mb-xl-8 mt-8"  id="table">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    ...
                    <!--end::Svg Icon-->Add Expense</a>

                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="{{ route('expense.trashed') }}" class="btn btn-sm btn-light-danger">View Trashed</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc42ae3b0ad">
                        ...
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('expense.status') }}">
                            @csrf
                            <div class="px-7 py-5">
                                <!--begin::Input group-->
                                <div class="mb-10">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-200px">Paid By</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            ...
                                            <span class="text-muted fw-bold text-muted d-block fs-7">Amount: {{ $row->amount }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $row->paid_by }}</a>
                                    <span class="text-muted fw-bold text-muted d-block fs-7">Paid To: {{ $row->paid_to }}</span>
                                </td>
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $row->description }}</a>
                                </td>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('expense.edit', $row->id) }}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                                    ...
                                    <form style="display:inline;" action="{{ route('expense.delete', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Add New Expense</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
