            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                ...
                <form id="updateForm" class="form" action="javascript:void(0)" method="POST">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Edit Shop Type</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8" id="data">
                        ...
                        <div class="col-md-9 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Shop Type Title</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a shop type name for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Shop Type Name" name="name" value="{{ $info->title }}" id="name" />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-3 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select Status" name="status">
                                <option value="{{ $info->status }}">{{ $info->status == 1 ? 'Active' : 'Inactive' }}</option>
                    ...
                    <div class="text-center">
                        <a class="btn btn-light me-3" href="{{ route('types') }}">Cancel</a>
