...
<div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 gap-2">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Shop Types</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
        ...
        <div class="card mb-5 mb-xl-8 mt-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Shop Types</span>
                ...
                <div class="card-toolbar">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        <!--begin::Form-->
                        <form action="{{ route('type.search') }}" method="POST">
                            @csrf
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                    ...
                    <!--end::Svg Icon-->Add Shop Type</a>

                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="{{ route('type.trashed') }}" class="btn btn-sm btn-light-danger">View Trashed</a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc42ae3b0ad">
                        ...
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('type.status') }}">
                            @csrf
                            <div class="px-7 py-5">
                                <!--begin::Input group-->
                                <div class="mb-10">
            ...
            <div class="card-body py-3">
                    ...
                    <table class="table align-middle gs-0 gy-4" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('type.edit', $row->id) }}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                                    ...
                                    <form style="display:inline;" action="{{ route('type.delete', $row->id) }}" method="POST" class="delete_record">
                                        @csrf
                                        @method('DELETE')
                ...
                @else
                <h3 style="text-align: center;">No Shop types found</h3>
                @endif
                <!--end::Table container-->
            </div>
            <!--begin::Body-->
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="saveForm" class="form" action="javascript:void(0)" method="POST">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Add New Shop Type</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-9 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">Shop Type</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a shop type for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Shop Type" name="name" id="name" />
                        </div>
                        <!--end::Col-->
...
if ($("#saveForm").length > 0) {
    $("#saveForm").validate({
        ...
        messages: {
            ...
            maxlength: "Shop Type name maxlength should be 50 characters long."
            },
        },
