            ...
            <div class="d-flex flex-stack align-items-stretch w-100">
                ...
                <div class="d-flex align-items-center align-items-lg-stretch me-5">
                    ...
                    <a href="{{ url('/') }}" class="d-flex align-items-center">
                        <img alt="Logo" src="/assets/media/logos/logo-marketpalace-white.svg" class="h-80px h-lg-80px" />
                    </a>
                    <!--end::Logo-->
                    <div class="align-self-end" id="kt_brand_tabs">
                        ...
                        <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_navs_wrapper', lg: '#kt_brand_tabs'}">
                            <ul class="nav flex-nowrap">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#kt_header_navs_tab_2">Sales</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#kt_header_navs_tab_3">Expenses</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                        ...
                        <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            ...
                            <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                                <span class="text-white opacity-75 fs-8 fw-bold lh-1 mb-1">{{ auth()->user()->name }}</span>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <!--begin::Menu item-->
                            @php
                                $shops = App\Models\Shop::where('user_id', auth()->user()->id)->get();
                            @endphp
                            @if(count($shops) > 0)
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-title">My Shops</span>
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('shop.session', $shop->id) }}" class="menu-link px-5">{{ $shop->name }}</a>
                                    </div>
                                    @endforeach
                                    <!--end::Menu item-->
                                </div>
                    ...
                    <div class="tab-pane fade active show" id="kt_header_navs_tab_1">
                        ...
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            ...
                            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold align-items-stretch flex-grow-1" id="#kt_header_menu" data-kt-menu="true">
                                ...
                                <div class="menu-item here {{ Route::current()->getName() == 'home' ? 'show' : ''}} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Route::current()->getName() == 'home' ? 'active' : ''}} py-3" href="{{ route('home') }}">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'shop') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'shop') ? 'active' : '' }} py-3" href="#">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'shop.add' ? 'active' : ''}} py-3" href="{{ route('shop.add') }}">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'shops' ? 'active' : ''}} py-3" href="{{ route('shops') }}">
                                                <span class="menu-icon">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'shop.trashed' ? 'active' : ''}} py-3" href="{{ route('shop.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'type') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'type') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Shop Types</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">

                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'type.add' ? 'active' : ''}} py-3" href="{{ route('type.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'types' ? 'active' : ''}} py-3" href="{{ route('types') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'type.trashed' ? 'active' : ''}} py-3" href="{{ route('type.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'brand') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'brand') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Brands</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'brands' ? 'active' : ''}} py-3" href="{{ route('brands') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'brand.add' ? 'active' : ''}} py-3" href="{{ route('brand.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'brand.trashed' ? 'active' : ''}} py-3" href="{{ route('brand.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                {{-- for medical --}}
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'compan') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'compan') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Companies</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'companies' ? 'active' : ''}} py-3" href="{{ route('companies') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'company.add' ? 'active' : ''}} py-3" href="{{ route('company.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'company.trashed' ? 'active' : ''}} py-3" href="{{ route('company.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'categor') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'categor') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Categories</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'categories' ? 'active' : ''}} py-3" href="{{ route('categories') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'category.add' ? 'active' : ''}} py-3" href="{{ route('category.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'category.trashed' ? 'active' : ''}} py-3" href="{{ route('category.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'area') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'area') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Areas</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'areas' ? 'active' : ''}} py-3" href="{{ route('areas') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'area.add' ? 'active' : ''}} py-3" href="{{ route('area.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'area.trashed' ? 'active' : ''}} py-3" href="{{ route('area.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'saleman') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'saleman') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Salemans</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'salemans' ? 'active' : ''}} py-3" href="{{ route('salemans') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'saleman.add' ? 'active' : ''}} py-3" href="{{ route('saleman.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'saleman.trashed' ? 'active' : ''}} py-3" href="{{ route('saleman.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'customer') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'customer') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Customers</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'customers' ? 'active' : ''}} py-3" href="{{ route('customers') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'customer.add' ? 'active' : ''}} py-3" href="{{ route('customer.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'customer.trashed' ? 'active' : ''}} py-3" href="{{ route('customer.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'dealer') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'dealer') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Dealers</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'dealers' ? 'active' : ''}} py-3" href="{{ route('dealers') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'dealer.add' ? 'active' : ''}} py-3" href="{{ route('dealer.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'dealer.trashed' ? 'active' : ''}} py-3" href="{{ route('dealer.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here {{ Str::contains(Route::current()->getName(), 'expense') ? 'show' : '' }} menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link {{ Str::contains(Route::current()->getName(), 'expense') ? 'active' : '' }} py-3" href="#">
                                        <span class="menu-title">Expenses</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'expenses' ? 'active' : ''}} py-3" href="{{ route('expenses') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'expense.add' ? 'active' : ''}} py-3" href="{{ route('expense.add') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ Route::current()->getName() == 'expense.trashed' ? 'active' : ''}} py-3" href="{{ route('expense.trashed') }}">
                                                <span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                                    <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
